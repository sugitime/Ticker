...
function display_latest_tweets(
    ...
    $accesstoken,
    $accesstokensecret,
    $tweets_to_display   = 15,               // Number of tweets you would like to display. (Default : 5)
    $cache_file          = './twitter/tweets.txt',  // Change this to the path of your cache file. (Default : ./tweets.txt)
    ...
    if (time() - $cachetime < $cache_file_created) {
        ...
        if($connection){
            ...
            if (count($get_tweets)) {
                ...
                //Screw it, just return the array.
                return $get_tweets;

                //IF YOU GET WEIRD ERRORS, UNCOMMENT THIS!
                //var_dump($get_tweets);
                // Iterate over tweets.
